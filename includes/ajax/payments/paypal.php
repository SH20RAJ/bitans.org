...
try {
  ...
  switch ($_POST['handle']) {
    case 'packages':
      ...
      // get paypal link
      $link = paypal_payment_link("packages", $package['price'], $package['package_id']);
      break;
    ...
    case 'wallet':
      ...
      // get paypal link
      $link = paypal_payment_link("wallet", $_POST['price']);
      break;
    ...
    case 'donate':
      ...
      // get paypal link
      $link = paypal_payment_link("donate", $_POST['price'], $_POST['post_id']);
      break;
    ...
    case 'subscribe':
      ...
      // get paypal link
      $link = paypal_payment_link("subscribe", $monetization_plan['price'], $_POST['plan_id']);
      break;
    ...
    case 'paid_post':
      ...
      // get paypal link
      $link = paypal_payment_link("paid_post", $post['post_price'], $_POST['post_id']);
      break;
    ...
    case 'movies':
      ...
      // get paypal link
      $link = paypal_payment_link("movies", $movie['price'], $_POST['movie_id']);
      break;
