...
// check if MoneyPoolsCash enabled
...
try {
  ...
  switch ($_POST['handle']) {
    case 'packages':
      ...
      // get moneypoolscash link
      $link = moneypoolscash("packages", $package['price'], $package['package_id']);
      break;
    ...
    case 'wallet':
      ...
      // get moneypoolscash link
      $link = moneypoolscash("wallet", $_POST['price']);
      break;
    ...
    case 'donate':
      ...
      // get moneypoolscash link
      $link = moneypoolscash("donate", $_POST['price'], $_POST['post_id']);
      break;
    ...
    case 'subscribe':
      ...
      // get moneypoolscash link
      $link = moneypoolscash("subscribe", $monetization_plan['price'], $_POST['plan_id']);
      break;
    ...
    case 'paid_post':
      ...
      // get moneypoolscash link
      $link = moneypoolscash("paid_post", $post['post_price'], $_POST['post_id']);
      break;
    ...
    case 'movies':
      ...
      // get moneypoolscash link
      $link = moneypoolscash("movies", $movie['price'], $_POST['movie_id']);
      break;
