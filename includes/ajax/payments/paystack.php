...
try {
  ...
  switch ($_POST['handle']) {
    ...
    case 'subscribe':
      ...
      // get paystack link
      $link = paystack("subscribe", $monetization_plan['price'], $_POST['plan_id'], $_POST['node_type']);
      break;
    ...
    case 'paid_post':
      ...
      // get paystack link
      $link = paystack("paid_post", $post['post_price'], $_POST['post_id']);
      break;
    ...
    case 'movies':
      ...
      // get paystack link
      $link = paystack("movies", $movie['price'], $_POST['movie_id']);
      break;
