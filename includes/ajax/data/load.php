...
if ($system["system_public"] && !in_array($_POST['get'], ["newsfeed", "posts_profile", "posts_page", "posts_group", "posts_event", "suggested_pages", "suggested_groups", "suggested_events", "articles", "category_articles", "fundings", "games", "search_posts", "search_articles", "search_users", "search_pages", "search_groups", "search_events", "reviews"])) {
  user_access(true);
}
...
try {
  ...
  switch ($_POST['get']) {
    ...
    case 'articles':
      /* get articles */
      $data = $user->get_articles(['offset' => $_POST['offset']]);
      break;
    ...
    case 'category_articles':
      ...
      $data = $user->get_articles(["category" => $_POST['id'], 'offset' => $_POST['offset']]);
      break;

    case 'fundings':
      /* get fundings */
      $data = $user->get_fundings(['offset' => $_POST['offset']]);
      break;
    ...
    case 'pages':
      /* get viewer pages */
      $data = $user->get_pages(['offset' => $_POST['offset']]);
      break;

    case 'suggested_pages':
      /* get suggested pages */
      $data = $user->get_pages(['suggested' => true, 'offset' => $_POST['offset']]);
      break;
    ...
    case 'category_pages':
      ...
      /* get category pages */
      $data = $user->get_pages(['suggested' => true, 'category_id' => $_POST['id'], 'offset' => $_POST['offset']]);
      break;
    ...
    case 'profile_pages':
      ...
      $data = $user->get_pages(['user_id' => $_POST['uid'], 'offset' => $_POST['offset']]);
      break;
    ...
    case 'groups':
      /* get viewer groups */
      $data = $user->get_groups(['offset' => $_POST['offset']]);
      break;

    case 'suggested_groups':
      /* get suggested groups */
      $data = $user->get_groups(['suggested' => true, 'offset' => $_POST['offset']]);
      break;
    ...
    case 'category_groups':
      ...
      /* get category groups */
      $data = $user->get_groups(['suggested' => true, 'category_id' => $_POST['id'], 'offset' => $_POST['offset']]);
      break;
    ...
    case 'profile_groups':
      ...
      $data = $user->get_groups(['user_id' => $_POST['uid'], 'offset' => $_POST['offset']]);
      break;

    case 'events':
      /* get viewer events */
      $data = $user->get_events(['offset' => $_POST['offset']]);
      break;

    case 'suggested_events':
      /* get suggested events */
      $data = $user->get_events(['suggested' => true, 'offset' => $_POST['offset']]);
      break;
    ...
    case 'category_events':
      ...
      /* get category events */
      $data = $user->get_events(['suggested' => true, 'category_id' => $_POST['id'], 'offset' => $_POST['offset']]);
      break;

    case 'going_events':
      /* get going events */
      $data = $user->get_events(['filter' => 'going', 'offset' => $_POST['offset']]);
      break;

    case 'interested_events':
      /* get interested events */
      $data = $user->get_events(['filter' => 'interested', 'offset' => $_POST['offset']]);
      break;

    case 'invited_events':
      /* get invited events */
      $data = $user->get_events(['filter' => 'invited', 'offset' => $_POST['offset']]);
      break;
