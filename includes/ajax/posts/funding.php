...
try {
  ...
  switch ($_REQUEST['do']) {
    ...
    case 'donate':
      ...
      // return
      modal("#payment", "{'handle': 'donate', 'id': '" . $_GET['post_id'] . "', 'price': '" . $_POST['amount'] . "', 'vat': '" . get_payment_vat_value($_POST['amount']) . "', 'fees': '" . get_payment_fees_value($_POST['amount']) . "', 'total': '" . get_payment_total_value($_POST['amount']) . "', 'total_printed': '" . get_payment_total_value($_POST['amount'], true) . "'}");
      break;
