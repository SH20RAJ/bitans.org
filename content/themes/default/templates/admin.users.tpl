<div class="card">
  <div class="card-header with-icon">
    ...
    {if $sub_view != "" && !in_array($sub_view, ['edit', 'not_activated'])} &rsaquo; {__($sub_view|capitalize)}{/if}
  ...
  {if $sub_view == "" || $sub_view == "admins" || $sub_view == "moderators" || $sub_view == "online" || $sub_view == "banned" || $sub_view == "not_activated" || $sub_view == "find"}
