            ...
            <div class="row">
              <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                <a href="{$system['system_url']}/directory/users" class="directory-card">
                  {include file='__svg_icons.tpl' icon="find_people" class="main-icon" width="120px" height="120px"}
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                <a href="{$system['system_url']}/directory/posts" class="directory-card">
                  {include file='__svg_icons.tpl' icon="newsfeed" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['pages_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/directory/pages" class="directory-card">
                    {include file='__svg_icons.tpl' icon="pages" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['groups_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/directory/groups" class="directory-card">
                    {include file='__svg_icons.tpl' icon="groups" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['events_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/directory/events" class="directory-card">
                    {include file='__svg_icons.tpl' icon="events" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['blogs_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/blogs" class="directory-card">
                    {include file='__svg_icons.tpl' icon="blogs" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['market_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/market" class="directory-card">
                    {include file='__svg_icons.tpl' icon="market" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['funding_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/funding" class="directory-card">
                    {include file='__svg_icons.tpl' icon="funding" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['offers_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/offers" class="directory-card">
                    {include file='__svg_icons.tpl' icon="offers" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['jobs_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/jobs" class="directory-card">
                    {include file='__svg_icons.tpl' icon="jobs" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['forums_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/forums" class="directory-card">
                    {include file='__svg_icons.tpl' icon="forums" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['movies_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/movies" class="directory-card">
                    {include file='__svg_icons.tpl' icon="movies" class="main-icon" width="120px" height="120px"}
              ...
              {if $system['games_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/directory/games" class="directory-card">
                    {include file='__svg_icons.tpl' icon="games" class="main-icon" width="120px" height="120px"}
